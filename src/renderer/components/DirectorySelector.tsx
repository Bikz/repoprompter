    ...
    <div className="flex flex-col gap-3">
      ...
      {baseDir && (
        <div className="mt-2">
          ...
          <div className="bg-gray-100 p-2 rounded text-xs mt-1 border border-gray-200 flex items-center">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-1 text-gray-600">
            ...
            <span className="ml-1 text-gray-500 truncate" title={baseDir}>({baseDir})</span>
          </div>
        </div>
      )}
    </div>
